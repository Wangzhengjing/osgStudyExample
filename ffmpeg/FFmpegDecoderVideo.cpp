...
void FFmpegDecoderVideo::open(AVStream * const stream)
{
    ...
    std::cout<<"frame_rate_num : "<<stream->avg_frame_rate.num<<std::endl;
    std::cout<<"frame_rate_den : "<<stream->avg_frame_rate.den<<std::endl;
    std::cout<<"frame rate : "<<m_frame_rate<<std::endl;
    std::cout<<"m_context->codec_id : "<<AV_CODEC_ID_FFMETADATA<<std::endl;
    std::cout<<"m_context->codec_id : "<<m_context->codec_id<<std::endl;
...
void FFmpegDecoderVideo::run()
{
    ...
    {
        std::cout << "FFmpegDecoderVideo::run : " << error.what() << std::endl;
    }

    catch (...)
    {
        std::cout << "FFmpegDecoderVideo::run : unhandled exception" << std::endl;
    }
}
