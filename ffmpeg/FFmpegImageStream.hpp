...
namespace osgFFmpeg
{
    ...
    public:
        ...
        typedef unsigned char* (*transformcb_p)(int width, int height, unsigned char*);
        void setTransCallback(transformcb_p cb);
        transformcb_p getTransCallback();
